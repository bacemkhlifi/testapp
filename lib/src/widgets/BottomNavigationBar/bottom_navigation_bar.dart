        ...
        child: AnimatedContainer(
          ...
          child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                  color: isEnable ? Color.fromARGB(255, 5, 5, 5) : Colors.white,
                  boxShadow: <BoxShadow>[
                    BoxShadow(
        ...
        children: [
          ...
          Positioned(
            ...
            child: Row(
              ...
              children: <Widget>[
                _icon(Icons.store, _selectedIndex == 0, 0),
                _icon(Icons.mail, _selectedIndex == 1, 1),
                _icon(Icons.favorite, _selectedIndex == 2, 2),
